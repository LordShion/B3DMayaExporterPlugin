...
//modified by silva Filipe to work with Maya API MString Datas
...
char* GetRelativeFilename(MString CurrentDirectory, MString AbsoluteFilename)
{
	const char * currentDirectory=CurrentDirectory.asChar();
	const char * absoluteFilename=AbsoluteFilename.asChar();
	MString RelativeFilename;
